...
<nav class="navbar fixed-top navbar-expand-lg navbar-light nav-settings">
    <div class="container-fluid">
        ...
        <!-- Logo -->
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-center">
                <li class="nav-item ">
                    <a class="nav-link" href="index.html"><h3 class="shop-name mb-0">MPeripherals</h3></a>
                </li>
            </ul>
        </div>
        <!-- Logo -->
        ...
        <div class="navbar-nav flex-row d-none d-md-flex width-280px ">
            <form class="input-group my-auto d-none d-sm-flex align-items-center justify-content-center">
                <input autocomplete="off" type="search" class="form-control form-settings" id="input-busca" placeholder="Busque por um produto " style="min-width: 125px;"/>
    ...
    <!-- Login, cadastrar e carrinho -->
        <ul class="navbar-nav flex-row">
            ...
            <div class="h-100 align-items-center my-auto">
            ...
            <li class="nav-item me-3 me-lg-1">
                <a class="nav-link text-center" href="pedido.html" id="carrinho">
                <span class=""><i class="fas fa-shopping-bag fa-lg icon-color icon-settings align-items-center"></i></span>
                <span class="badge rounded-pill badge-notification bg-danger" id="badgeCarrinho">0</span>
                </a>
            </li>
